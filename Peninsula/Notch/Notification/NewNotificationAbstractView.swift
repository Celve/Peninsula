...
struct NewQuiverView<Inner: View>: View {
    let inner: Inner
    let tapGesture: () -> Void
...
struct NewNotificationAbstractView: View {
    @StateObject var notchViewModel: NotchViewModel
    @StateObject var notifModel: NewNotificationModel = NewNotificationModel.shared
